...
public interface VariableSpace {
	 ...
	 * @param variableValue
	 *            The value of the variable to set. If the variableValue is
	 *            null, the variable is cleared from the list.
	 */
	void setVariable(String variableName, String variableValue);

	/**
	 * Get the value of a variable with a default in case the variable is not
	 * found.
	 * 
	 * @param variableName
	 ...
	 * @param variableName
	 *            The name of the variable
	 * @return the String value of a variable or null in case the variable could
	 *         not be found.
	 */
	String getVariable(String variableName);

	/**
	 * This method returns a boolean for the new variable check boxes. If the
	 * variable name is not set or the variable name is not specified, this
	 * method simply returns the default value. If not, it convert the variable
	 * value to a boolean. "Y", "YES" and "TRUE" all convert to true. (case
	 * insensitive)
	 * 
	...
	/**
	 * List the variables (not the values) that are currently in the variable
	 * space.
	 * 
	...
	/**
	 * Inject variables. The behaviour should be that the properties object will
	 * be stored and at the time the VariableSpace is initialized (or upon
	 * calling this method if the space is already initialized). After injecting
	 * the link of the properties object should be removed.
	 * 
	 * @param prop
