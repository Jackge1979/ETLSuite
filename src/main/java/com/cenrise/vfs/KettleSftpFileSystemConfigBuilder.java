...
/**
 * An SFTP FileSystemConfigBuilder that uses Kettle variables to build SFTP VFS
 ...
 * 
 */
public class KettleSftpFileSystemConfigBuilder extends
	...
	private static final Logger log = LoggerFactory
			.getLogger(KettleSftpFileSystemConfigBuilder.class);
	...
	private static class PentahoUserInfo implements com.jcraft.jsch.UserInfo {
